...
- Diverse test bookings created with 7 vehicles - SAME pickup/dropoff, SAME distance (35km), DIFFERENT vehicles
- Auto-assignment FIXED for ALL bookings (manual + Bareerah) - vehicles now auto-assign with models AND drivers
- Vehicle models properly displayed in booking details (e.g., BYD Han, Lexus ES 300H, etc.)
- Drivers tagged to vehicles and assigned automatically to bookings
- Test bookings show full assignment: Vehicle Model, Vehicle ID, Driver Name, Driver ID - ALL WORKING
